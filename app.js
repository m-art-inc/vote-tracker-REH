...
//spider
var snake1 = new Photo('<img src="img/snake-1.jpg" />');
var snake2 = new Photo('<img src="img/snake-2.jpg" />');
//snake
var dog1 = new Photo('<img src="img/dog-1.jpg" />');
//dog
//dog
var clown1 = new Photo('<img src="img/clown-1.jpg" />');
var clown3 = new Photo('<img src="img/clown-3.jpg" />');
//clown
var germ1 = new Photo('<img src="img/germ-1.jpg" />');
//germ
//germ
var heights1 = new Photo('<img src="img/heights-1.jpg" />');
var heights2 = new Photo('<img src="img/heights-2.jpg" />');
var heights3 = new Photo('<img src="img/heights-3.jpg" />');
var kitten1 = new Photo('<img src="img/kitten-1.jpg" />');
var kitten2 = new Photo('<img src="img/kitten-2.jpg" />');
var lightning1 = new Photo('<img src="img/lightning-1.jpg" />');
var lightning2 = new Photo('<img src="img/lightning-2.jpg" />');

var needle1 = new Photo('<img src="img/needles-1.jpg" />');
var needle2 = new Photo('<img src="img/needles-2.jpg" />');
var needle3 = new Photo('<img src="img/needles-3.jpg" />');
